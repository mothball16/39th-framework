...
export type RequestSuppressionPayload = { target: Instance, level: number, factor: number, limit: number }
export type ReportSuppressionPayload = { level: number, factor: number, limit: number }
